          ...
          ar -> {
            if (ar.succeeded()) {
              ...
              HealthCheckHandler healthCheckHandler =
                  HealthCheckHandler.createWithHealthChecks(HealthChecks.create(vertx));
              ...
              HealthCheckHandler readinessHandler =
                  HealthCheckHandler.createWithHealthChecks(HealthChecks.create(vertx));
              ...
              System.err.println(
                  "Error booting service [{}]" + startPromise.future().cause().getMessage());
